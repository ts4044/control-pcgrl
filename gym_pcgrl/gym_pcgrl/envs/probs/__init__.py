...
from gym_pcgrl.envs.probs.microstructure.microstructure_prob import (
    MicroStructureProblem,
)
...
from gym_pcgrl.envs.probs.minecraft.minecraft_3Dmaze_ctrl_prob import (
    Minecraft3DmazeCtrlProblem,
)
from gym_pcgrl.envs.probs.minecraft.minecraft_3DZelda_prob import (
    Minecraft3DZeldaProblem,
)
from gym_pcgrl.envs.probs.minecraft.minecraft_3DZelda_ctrl_prob import (
    Minecraft3DZeldaCtrlProblem,
)
