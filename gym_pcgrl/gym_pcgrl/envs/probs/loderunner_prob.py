...
class LoderunnerProblem(Problem):
    ...
    def render(self, map):
        ...
        if self._graphics == None:
            self._graphics = {
                "solid": Image.open(
                    os.path.dirname(__file__) + "/loderunner/solid.png"
                ).convert("RGBA"),
                "brick": Image.open(
                    os.path.dirname(__file__) + "/loderunner/brick.png"
                ).convert("RGBA"),
                "ladder": Image.open(
                    os.path.dirname(__file__) + "/loderunner/ladder.png"
                ).convert("RGBA"),
                "rope": Image.open(
                    os.path.dirname(__file__) + "/loderunner/rope.png"
                ).convert("RGBA"),
                "enemy": Image.open(
                    os.path.dirname(__file__) + "/loderunner/enemy.png"
                ).convert("RGBA"),
                "gold": Image.open(
                    os.path.dirname(__file__) + "/loderunner/gold.png"
                ).convert("RGBA"),
                "empty": Image.open(
                    os.path.dirname(__file__) + "/loderunner/empty.png"
                ).convert("RGBA"),
                "player": Image.open(
                    os.path.dirname(__file__) + "/loderunner/player.png"
                ).convert("RGBA"),
            }
        # self._border_size = (0, 0)
